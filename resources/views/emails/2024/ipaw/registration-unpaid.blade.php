...
<p class="sub" style="margin-top: 15px; color: red;">Please note that NO BADGE will be issued without prior payment on your registration. Kindly ensure to process your payment before the event date. Onsite payment is available on a <strong><em>CASH BASIS</em></strong> only. </p>

<p class="sub" style="margin-top: 15px;">Please present your business card as a reference to ease the verification process. Your badge details will appear as the below. To request changes, kindly respond to this email at the earliest to rectify your badge. </p>
