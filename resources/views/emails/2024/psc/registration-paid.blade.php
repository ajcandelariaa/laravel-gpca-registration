...
<p class="sub" style="margin-top: 15px;">Thank you for registering to attend the <a href="{{ $details['eventLink'] }}" target="_blank">{{ $details['eventName'] }}</a>, taking place from 07-10 October 2024 at the {{ $details['eventLocation'] }}. By registering as a delegate, you are subject to the terms & condition. </p>

<p class="sub" style="margin-top: 15px;">Your registration has been confirmed and you can access the workshop on 7<sup>th</sup> October, participate in the discussions during the conference and meet the key players at the exhibition floor from 08-10 October. You will gain access to the networking features and gala dinner during the duration of the event. Please find below the summary of your booking confirmation.</p>
