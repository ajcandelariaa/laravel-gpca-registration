...
<a href="https://www.marriott.com/event-reservations/reservation-link.mi?id=1751879868394&key=GRP&app=resvlink" target="_blank">
    <img src="http://gpca.org.ae/conferences/anc/wp-content/uploads/2025/07/email-notif-banner-v2.jpg">
</a>
    
<p class="sub" style="margin-top: 15px;">Dear {{ $details['name'] }},</p>

<p class="sub" style="margin-top: 15px;">Thank you for registering to attend the <a href="{{ $details['eventLink'] }}" target="_blank">{{ $details['eventName'] }}</a>, 30 September to 01 October 2025 in the {{ $details['eventLocation'] }}. By registering as a delegate, you are subject to the terms and conditions outlined in the invoice.</p>
...
<p class="sub" style="margin-top: 20px; text-decoration: underline;"><strong>3<sup>rd</sup> Operational Excellence Workshop</strong></p>

<p class="sub" style="margin-top: 5px;">The GPCA Operational Excellence Workshop is designed to empower professionals with the knowledge and tools to achieve operational excellence while ensuring safety, sustainability, and efficiency in Agri-Nutrients Production plants. This workshop will explore critical topics such as EHSS and reliability standards, process optimization, process safety management, quality control, and successful plant turnaround strategies. Through real-world case studies and expert insights, participants will learn how to install a culture of discipline, implement best practices, and enhance operator care programs to drive performance and ownership of processes. Don’t miss this opportunity to gain actionable strategies, connect with industry peers, and stay ahead in the evolving landscape of manufacturing excellence.</p>
