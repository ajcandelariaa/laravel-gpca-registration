                    ...
                    @foreach ($upcomingEvents as $event)
                        <div class="bg-gray-100 px-4 py-4 rounded-lg">
                            ...
                            <a href="{{ $event['eventLink'] }}"
                                class="inline-block bg-registrationPrimaryColorHover hover:bg-registrationPrimaryColor text-white font-medium py-1 px-10 rounded-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110 mt-4 animate-bounce" target="_blank">
                                Register now
                            </a>
                        </div>
                    @endforeach
