<div>
    ...
    <div class="mx-10 my-10">
        ...
        <div class="shadow-lg my-5 pt-5 bg-white rounded-md">
            <h1 class="text-center text-2xl bg-registrationPrimaryColor text-white py-4">Confirmed Visitors</h1>
                ...
                @foreach ($finalListsOfVisitors as $visitorIndex => $finalListsOfVisitor)
                    <div
                        ...
                        <div class="col-span-2 break-words text-sm">
                            {{ $finalListsOfVisitor['visitorSalutation'] }} {{ $finalListsOfVisitor['visitorFName'] }} {{ $finalListsOfVisitor['visitorMName'] }} {{ $finalListsOfVisitor['visitorLName'] }}
                        </div>
                        ...
                        <div class="col-span-1 break-words text-sm">
                            ...
                            <button type="button" wire:click="printBadgeClicked('{{ $finalListsOfVisitor['visitorType'] }}', {{ $finalListsOfVisitor['visitorId'] }}, {{ $visitorIndex }})" class="bg-green-800 hover:bg-green-900 text-white py-1 px-2 w-full rounded-md text-xs text-center mt-2">
                                Print
                            </button>
                        </div>
                    </div>
