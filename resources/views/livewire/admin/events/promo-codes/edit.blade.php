    ...
    <form>
        ...
        <div class="p-5">
            ...
            <div class="space-y-2 mt-5">
                ...
                <div>
                    <input type="number" wire:model="number_of_codes" step="1" min="1" placeholder="1" max="10000" class="bg-registrationInputFieldsBGColor w-full py-1 px-3 outline-registrationPrimaryColor">
