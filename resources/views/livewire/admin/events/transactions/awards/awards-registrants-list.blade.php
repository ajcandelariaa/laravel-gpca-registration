        ...
        <div class="shadow-lg my-5 pt-5 bg-white rounded-md">
            ...
            @else
                ...
                class="grid grid-cols-12 gap-5 px-4 py-2 mb-1 text-center items-center text-sm {{ $count % 2 == 0 ? 'bg-registrationInputFieldsBGColor' : 'bg-registrationCardBGColor' }}">
                        ...
                        <div class="col-span-2">{{ $finalListOfRegistrant['companyName'] }}</div>
                        <div class="col-span-2">{{ $finalListOfRegistrant['category'] }}</div>
                        <div class="col-span-1">{{ $finalListOfRegistrant['passType'] }}</div>
                        ...
                        <div class="col-span-1">
                            <a href="{{ route('admin.event.registrants.detail.view', ['eventCategory' => $eventCategory, 'eventId' => $eventId, 'registrantId' => $finalListOfRegistrant['mainParticipantId']]) }}"
