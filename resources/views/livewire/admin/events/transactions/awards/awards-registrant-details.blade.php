<div>
    ...
    <div class="container mx-auto my-10">
            ...
            <div class="col-span-5">
                ...
                <div class="mt-3 bg-registrationInputFieldsBGColor py-1 px-1">
                    ...
                    <div class="grid grid-cols-2 bg-white py-3 px-4 gap-10">
                        <p>Entry form:</p>
                        <a href="{{ route('event-download-file', ['eventCategory'=>$event->category, 'eventId'=>$event->id, 'documentId'=>$finalData['entryFormId'] ]) }}"
                            target="_blank"
                            ...
                            @foreach ($participants as $innerIndex => $innerParticipant)
                                <div class="bg-white py-3 px-4 m-2">
                                    ...
                                    <div class="grid grid-cols-2 mt-3 gap-2 px-6">
                                        ...
                                        <p>Nationality:</p>
                                        <p class="font-bold">{{ $innerParticipant['nationality'] }}</p>
        ...
        @if ($showParticipantModal)
            @include('livewire.admin.events.transactions.awards.edit-forms.edit_participant_form')
        @endif

        @if ($showAdditionalDetailsModal)
            @include('livewire.admin.events.transactions.awards.edit-forms.edit_additional_details_form')
        @endif

        @if ($showTransactionRemarksModal)
            @include('livewire.admin.events.transactions.awards.edit-forms.edit_remarks')
        @endif

        @if ($showParticipantCancellationModal)
            @include('livewire.admin.events.transactions.awards.participant-cancellation.participant_cancellation_modal')
        @endif

        @if ($showMarkAsPaidModal)
            @include('livewire.admin.events.transactions.awards.mark-paid.mark_as_paid_form')
        @endif
    </div>
</div>
