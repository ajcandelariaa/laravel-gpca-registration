<div class="container mx-auto my-10">
    ...
    <div class="xl:float-left mx-5">
        @include('livewire.registration.rcc_awards.progress.progress_bar_vertical')
        @include('livewire.registration.rcc_awards.progress.progress_bar_horizontal')
    </div>

    <div class="form-container mt-10 xl:mt-0">
        <form wire:submit.prevent="submit">
            @if ($currentStep == 1)
                @include('livewire.registration.rcc_awards.step.first')
            @elseif ($currentStep == 2)
                @include('livewire.registration.rcc_awards.step.second')
            @elseif ($currentStep == 3)
                @include('livewire.registration.rcc_awards.step.third')
            @else
                @include('livewire.registration.rcc_awards.step.fourth')
            @endif
