<div class="mx-5">
    <div>
        ...
        <div class="italic mt-5">
            By registering your details, you understand that your personal data will be handled according to <a
                ...
                class="text-registrationPrimaryColor underline ">GPCA Privacy Policy</a>
        </div>
    </div>
    ...
    <div class="mt-5">
        ...
        <div class="mt-5 flex gap-5 items-start">
            @if ($companyName == "Almajdouie & De Rijke Limited Co." || $companyName == "SABIC")
    ...
    <div class="mt-10">
        @include('livewire.registration.awards.package_summary.package_rows')
        @include('livewire.registration.awards.package_summary.package_cols')
    </div>
</div>
