<div class="mx-5">
    ...
    <div class="mt-5 grid grid-cols-2 gap-y-3 gap-x-5">
        ...
        {{-- ROW 3 --}}
        <div class="col-span-2 sm:col-span-2 space-y-2">
            <div class="text-registrationPrimaryColor">
        ...
        <div class="space-y-2 col-span-2">
            <div class="grid grid-cols-2 gap-x-5">
                <div class="col-span-2 sm:col-span-1">
                    <div class="text-registrationPrimaryColor">
                        Entry form <span class="text-red-500">*</span> <span class="italic text-xs text-red-600 ml-2">(.PDF, .doc, .docx format only)</span> 
                    </div>
                    <div>
                ...
                <div class="col-span-2 sm:col-span-1">
                    <div class="text-registrationPrimaryColor">
                        @if ($category == "Best LSP of the Year")
                            Please submit the following documents: <span class="italic text-xs text-red-600">(.PDF, .doc, .docx format only)</span>
                            <br>
