<div class="container mx-auto my-10">
    ...
    <div class="xl:float-left mx-5">
        @include('livewire.registration.spouse.progress.progress_bar_vertical')
        @include('livewire.registration.spouse.progress.progress_bar_horizontal')
    </div>

    <div class="form-container mt-10 xl:mt-0">
        <form wire:submit.prevent="submit">
            @if ($currentStep == 1)
                @include('livewire.registration.spouse.step.first')
            @elseif ($currentStep == 2)
                @include('livewire.registration.spouse.step.second')
            @else
                @include('livewire.registration.spouse.step.third')
            @endif
