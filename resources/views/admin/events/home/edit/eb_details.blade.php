...
<div class="space-y-2 col-span-2 grid grid-cols-4 gap-x-5 items-start">
    ...
    <div>
        ...
        <div>
            @if ($event->eb_end_date != null || $event->eb_member_rate != null || $event->eb_nmember_rate != null || $event->eb_full_member_rate != null)
                <input id="eb_full_member_rate" type="number" name="eb_full_member_rate" step="0.01" min="0"
                    placeholder="0.00" max="99999.99" value="{{ $event->eb_full_member_rate }}"
                    class="bg-registrationInputFieldsBGColor w-full py-1 px-3 outline-registrationPrimaryColor">
            @else
                <input readonly id="eb_full_member_rate" type="number" name="eb_full_member_rate" step="0.01" min="0"
                    placeholder="0.00" max="99999.99" value="{{ $event->eb_full_member_rate }}"
                    class="cursor-not-allowed bg-registrationInputFieldsBGColor w-full py-1 px-3 outline-none">
            @endif
