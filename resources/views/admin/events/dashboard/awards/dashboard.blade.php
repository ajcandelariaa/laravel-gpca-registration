    ...
    <div class="container mx-auto my-10">
        ...
        <div class="grid grid-cols-3 gap-4 text-center">
            <div class="bg-blue-500 p-4 rounded-lg shadow-lg">
                <h3 class="text-lg font-semibold text-white">Confirmed participants</h3>
                <p class="text-4xl font-bold text-white">{{ $finalData['totalConfirmedParticipants'] }}</p>
            </div>
            <div class="bg-blue-500 p-4 rounded-lg shadow-lg">
                <h3 class="text-lg font-semibold text-white">Total participants</h3>
                <p class="text-4xl font-bold text-white">{{ $finalData['totalParticipants'] }}</p>
            </div>
            <div class="bg-blue-500 p-4 rounded-lg shadow-lg">
