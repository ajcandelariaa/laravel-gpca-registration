    ...
    <div class="container mx-auto my-10">
        ...
        <div class="grid grid-cols-3 gap-4 text-center">
            <div class="bg-blue-500 p-4 rounded-lg shadow-lg">
                <h3 class="text-lg font-semibold text-white">Confirmed spouses</h3>
                <p class="text-4xl font-bold text-white">{{ $finalData['totalConfirmedSpouses'] }}</p>
            </div>
            <div class="bg-blue-500 p-4 rounded-lg shadow-lg">
                <h3 class="text-lg font-semibold text-white">Total spouses</h3>
                <p class="text-4xl font-bold text-white">{{ $finalData['totalSpouses'] }}</p>
            </div>
            <div class="bg-blue-500 p-4 rounded-lg shadow-lg">
        ...
        <div class="grid grid-cols-3 gap-4 text-center mt-10">
            <div class="bg-green-500 p-4 rounded-lg shadow-lg">
                ...
                <p class="text-4xl font-bold text-white">$ {{ number_format($finalData['totalAmountPaid'], 2, '.', ',') }}
                </p>
            </div>
            <div class="bg-green-500 p-4 rounded-lg shadow-lg">
            ...
            <div class="bg-green-500 p-4 rounded-lg shadow-lg">
                ...
                <p class="text-4xl font-bold text-white">$
                    {{ number_format($finalData['totalAmountPaidToday'], 2, '.', ',') }}</p>
            </div>
        </div>
