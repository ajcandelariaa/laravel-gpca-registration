...
@section('content')
    ...
    <table class="invoice-body">
        ...
        @foreach ($invoiceDetails as $visitorInvoiceDetails)
            @if ($count == 1)
    ...
    <div class="terms-and-condition">
        ...
        <ol>
            ...
            <li> If any visitor is unable to attend, we will accept a substitute visitor at no extra cost. Please notify us
                in writing an email to: registration@gpca.org.ae with the name, job title, email address and telephone
                number of both the registered and substitute visitor.</li>
            <li>Refund Policy
                <p class="inside-li">3.1 If visitor/s cancelled their registration 31 days before the event, they will get a
                    refund of 75% on the amount paid for the registration fee.</p>
