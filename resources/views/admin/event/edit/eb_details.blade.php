...
<div class="space-y-2 col-span-2 grid grid-cols-3 gap-x-5 items-start">
    ...
    <div>
        ...
        <div>
            <input readonly id="eb_end_date" type="date" name="eb_end_date" placeholder="Select a date" value="{{ $event->eb_end_date }}"
