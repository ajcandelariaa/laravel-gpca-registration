...
<div class="space-y-2 col-span-2 grid grid-cols-3 gap-5 items-start">
    ...
    <div class="col-span-1">
        ...
        <div>
            <input type="text" name="badge_footer_link" value="{{ $event->badge_footer_link }}"
    ...
    <div class="col-span-1">
        ...
        <div>
            <input type="text" name="badge_footer_link_color" value="{{ $event->badge_footer_link_color }}"
                class="bg-registrationInputFieldsBGColor w-full py-1 px-3 outline-registrationPrimaryColor">
    ...
    <div class="col-span-1">
        ...
        <div>
            <input type="text" name="badge_footer_bg_color" value="{{ $event->badge_footer_bg_color }}"
                class="bg-registrationInputFieldsBGColor w-full py-1 px-3 outline-registrationPrimaryColor">
    ...
    <div class="col-span-3 grid grid-cols-2 gap-5 items-start">
        <div class="space-y-2">
            ...
            <div class="flex gap-3 flex-col">
                ...
                <div>
                    <img src="{{ Storage::url($event->badge_front_banner) }}" alt="badge_front_banner" class="h-36 object-cover" id="badgeFrontBanner">
                </div>
            </div>
        </div>
        ...
        <div class="space-y-2">
            ...
            <div class="flex gap-3 flex-col">
                ...
                <div>
                    <img src="{{ Storage::url($event->badge_back_banner) }}" alt="badge_back_banner" class="h-36 object-cover"
                        id="badgeBackBanner">
                </div>
            </div>
        </div>
