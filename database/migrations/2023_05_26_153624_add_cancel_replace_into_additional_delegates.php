...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('additional_delegates', function (Blueprint $table) {
            ...
            $table->string('delegate_replaced_type')->nullable();
            $table->unsignedBigInteger('delegate_replaced_from_id')->nullable();
    ...
    public function down()
    {
        Schema::table('additional_delegates', function (Blueprint $table) {
            ...
            $table->dropColumn('delegate_replaced_type');
            $table->dropColumn('delegate_replaced_from_id');
