...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('rcc_awards_additional_participants', function (Blueprint $table) {
            $table->id();
            ...
            $table->timestamps();
            $table->foreign('main_participant_id')->references('id')->on('rcc_awards_main_participants')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('rcc_awards_additional_participants');
    }
};
